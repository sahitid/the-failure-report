export default function Footer() {
  return (
    <footer className="bg-neutral-50">
      {/* Partnership Section */}
      <div className="px-6 py-5 border-t border-neutral-300">
        <div className="max-w-xl mx-auto">
          <div className="bg-white border border-neutral-300 p-4">
            <h3 className="text-sm font-display font-semibold text-neutral-900 mb-2">In Partnership with Wharton Wellness</h3>
      ...
      <div className="px-6 py-5 bg-white border-t border-neutral-300">
        <div className="max-w-xl mx-auto">
      ...
      {/* Contact & Footer */}
      <div className="px-6 py-5 bg-neutral-50 border-t border-neutral-300">
        <div className="max-w-xl mx-auto text-center">
          <p className="text-xs text-neutral-600 mb-2">
            <a href="mailto:thefailurereport@wharton.upenn.edu" className="text-neutral-900 hover:text-penn-red hover:underline font-medium transition-colors">
