export default function AMASection() {
  return (
    <section className="px-6 py-6 bg-neutral-900 border-b border-neutral-700">
      <div className="max-w-xl mx-auto">
        {/* Section Header */}
        <div className="mb-4">
          <h2 className="text-xl font-bold text-white mb-1">The Anonymous AMA</h2>
        ...
        {/* Featured Q&A */}
        <div className="bg-neutral-800 border-l-4 border-penn-blue p-5 mb-4">
          <div className="text-xs font-medium text-penn-blue uppercase tracking-wide mb-3">Question from Wharton '26</div>
          <div className="bg-penn-blue/10 p-4 rounded mb-4 border border-penn-blue/20">
