export default function AMASection() {
  return (
    <section className="px-6 py-6 bg-neutral-50 border-b border-neutral-300">
      <div className="max-w-xl mx-auto">
        {/* Section Header */}
        <div className="mb-4">
          <h2 className="text-xl font-display font-bold text-neutral-900 mb-1">The Anonymous AMA</h2>
        ...
        {/* Featured Q&A */}
        <div className="bg-white border-l-4 border-penn-blue p-5 mb-4">
          <div className="text-xs font-bold text-penn-blue uppercase tracking-wider mb-3">Question from Wharton '26</div>
          <div className="bg-penn-blue/5 p-4 rounded mb-4 border border-penn-blue/20">
            <p className="text-sm font-serif font-semibold text-neutral-900 leading-relaxed italic">
          ...
          <div className="border-l-4 border-penn-red pl-4">
            <div className="text-xs text-penn-red font-bold mb-3 uppercase tracking-wider">Response from Current Senior (Switched from Finance to Tech)</div>
